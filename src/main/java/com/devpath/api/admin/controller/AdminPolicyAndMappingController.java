...
public class AdminPolicyAndMappingController {
    ...
    @Operation(summary = "강의-노드 매핑 후보 조회", description = "태그 기반 자동 분류 결과 반환")
