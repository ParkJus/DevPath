...
public class PolicyGovernanceRequests {
    ...
    public static class UpdateSystemPolicy {
        @Schema(description = "플랫폼 기본 수수료율 (예: 15.0)", example = "15.0")
        private Double platformFeeRate;

        @Schema(description = "강사 기본 정산 비율 (예: 85.0)", example = "85.0")
    ...
    public static class UpdateStreamingPolicy {
        ...
        @Schema(description = "동시 접속 허용 기기 수", example = "3")
    ...
    public static class UpdateNodeMapping {
        @Schema(description = "해당 강의를 연결할 노드 ID 목록")
